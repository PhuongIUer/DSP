...
heart_rate = 0.0
update_data_task = None
# Music Player Initialization
pygame.mixer.init()
playlist = [
    {"path": r"C:/Users/khanh/Downloads/Short Song (English Song) [W Lyrics] 30 seconds.mp3", "condition": "<60"},
    {"path": r"C:/Users/khanh/Downloads/SHORT MUSIC - No Copyright Music - Royalty-free Music For Background 2023.mp3",
     "condition": "60-100"},
    {
        "path": r"C:/Users/khanh/Downloads/DSP-Fix1/DSP-Fix1/Downloads/DSP/Python-Music-Player-master/100+/Let It Be (Remastered 2009).mp3",
        "condition": ">100"}
]
...
# Label to show Heart Rate
hr_label = Label(root, text="Heart Rate: -- BPM", font=("Helvetica", 14), fg="blue")
...
def update_data():
    global ecg_buffer, processed_signal_buffer, heart_rate
    if ser.in_waiting > 0:
        try:
            ...
            if len(ecg_buffer) >= 1000:
                ...
                if processed_signal is not None:
                    ...
                    hr_label['text'] = f"Heart Rate: {heart_rate:.2f} BPM"
    ...
    global update_data_task
    update_data_task = root.after(10, update_data)


# Stop Measurement
def stop_measurement():
    global heart_rate
    root.after_cancel(update_data_task)
    if heart_rate < 60:
        tkinter.messagebox.showinfo("Measurement Stopped", "Your heart rate is below normal. Please check your health!")
    elif 60 <= heart_rate <= 100:
        tkinter.messagebox.showinfo("Measurement Stopped", "Your heart rate is normal. Keep up the good work!")
    else:
        tkinter.messagebox.showinfo("Measurement Stopped", "Your heart rate is above normal. Consider relaxing!")
    stop_song()
...
stop_measurement_button = ttk.Button(button_frame, text="Stop Measurement", command=stop_measurement)
stop_measurement_button.grid(row=0, column=4, padx=10)
